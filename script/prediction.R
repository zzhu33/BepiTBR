...
#output_path="/project/shared/xiao_wang/projects/Bcell_epitope/code/BepiTBR/example/test_output_BepiTBR_fasta/YP_009724393.1_predicted_analog"
script_path=args[1]
output_path=args[2]
...
write.table(predictions,file=paste(output_path,"/predictions.txt",sep=""),
